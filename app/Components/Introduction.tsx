...
export default function Introduction() {
  return (
    <section id="home" className={`${montserrat.className} my-64`}>
      ...
      <h1 className="text-neutral-200 text-7xl font-bold mt-8 md:text-6xl">
        Yannis Madu.
      </h1>
      <p className="text-slate-400 text-7xl font-bold mt-6 md:text-6xl">
        I build cool websites.
      </p>
      <p className="text-neutral-400 mt-7 mb-10 text-xl md:text-base">
